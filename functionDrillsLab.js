...
let nameGreeting2 = nameCheck('Mikko')
...
let colorRating1 = faveColorFinder('green')
let colorRating2 = faveColorFinder('black')
let colorRating3 = faveColorFinder('blue')
...
const greatMovie = bestMovie('Spiderman: No Way Home')
...
const yelling = (yell) => console.log(yell.toUpperCase())
...
myEmail = emailCheck('procoder@email.com')
